 ...
 * (module.etechflow.com). The broker opens a Stripe Checkout session on the
 * webstore's own account and returns the hosted pay URL; the portal issues the
 * SP-XXXX key once payment clears. No card keys live in Magento.
 */
class Checkout extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $gate = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('etechflow_vehicle/license/gate');
        ...
        $payload = json_encode([
            ...
            'magento_callback' => $this->getUrl('etechflow_vehicle/license/activated'),
            'magento_cancel'   => $this->getUrl('etechflow_vehicle/license/gate'),
        ]);
